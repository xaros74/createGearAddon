...
public class AllModTileEntities {
	...
	public static void register() {
		...
		HALFSHAFT_COG_TILE = CreateGearAddon.registrate().tileEntity("simple_halfshaft__kinetic", HalfshaftCogTile::new)
				.instance(() -> SingleRotatingInstance::new)
				.validBlocks(AllModBlocks.HALF_SHAFT_COGWHEEL, AllModBlocks.HALF_SHAFT_OAK_COGWHEEL,
						...
						AllModBlocks.LARGE_HALF_SHAFT_COGWHEEL, AllModBlocks.LARGE_HALF_SHAFT_OAK_COGWHEEL,
		...
		SHAFTLESS_COG_TILE = CreateGearAddon.registrate().tileEntity("simple_shaftless_kinetic", ShaftlessCogTile::new)
				.instance(() -> SingleRotatingInstance::new)
				.validBlocks(AllModBlocks.SHAFTLESS_COGWHEEL, AllModBlocks.SHAFTLESS_OAK_COGWHEEL,
						...
						AllModBlocks.LARGE_SHAFTLESS_COGWHEEL, AllModBlocks.LARGE_SHAFTLESS_OAK_COGWHEEL,
